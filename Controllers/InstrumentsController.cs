...
namespace Music_Store_Warehouse_App.Controllers
{
    public class InstrumentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Price,Description,EAN,SKU,SerialNumber,SupplierId,CategoryId")] Instrument instrument)
        {
        ...
        //Pomocne w wyrzucaniu błędów
            //else if (!ModelState.IsValid)
            //{
            //    var diagnostics = ModelState
            ...
            ViewData["CategoryId"] = new SelectList(_context.Category, "CategoryId", "Name", instrument.CategoryId);
            ViewData["SupplierId"] = new SelectList(_context.Supplier, "SupplierId", "Name", instrument.SupplierId);
            return View(instrument);
        }
