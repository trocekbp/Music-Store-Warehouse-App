...
namespace Music_Store_Warehouse_App.Controllers
{
    public class InstrumentFeaturesController : Controller
    {
        ...
        public InstrumentFeaturesController(Music_Store_Warehouse_AppContext context)
        {
            _context = context;
        }
        ...
        {
            var music_Store_Warehouse_AppContext = _context.InstrumentFeature.Include(i => i.FeatureDefinition).Include(i => i.Instrument);
